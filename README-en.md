...
# curl -o trivy.yaml https://github.com/mambient-innovation/gitlab-trivy-codequality-template/releases/latest/download/trivy.template.yaml
...
include:
  - remote: 'https://github.com/mambient-innovation/gitlab-trivy-codequality-template/releases/latest/download/trivy-scanning.template.yaml'
```
